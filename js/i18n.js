...
const I18N = {
  zh: {
    ...
    "p3.download": "下载 3MF",
    "p3.note": "3MF 里是一个模型、三个部件（山体 / 文字 / 路线），Bambu Studio、OrcaSlicer 打开后可给每个部件指定耗材；单色打印直接切片即可。建议 0.2 mm 层高，平放打印，无需支撑。",
  ...
  en: {
    ...
    "p3.ctaSub": "Real terrain · name on the base · 3MF export",
    ...
    "p3.note": "The 3MF holds one model with three parts (terrain / text / route). In Bambu Studio or OrcaSlicer give each part its own filament; for a single colour just slice. 0.2 mm layers, print flat, no supports needed.",
